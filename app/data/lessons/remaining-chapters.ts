...
const specs: ChapterSpec[] = [
  ...
  ["hospital", "医院看病", "병원과 진료", "🏥", ["挂号","身体","症状","检查","治疗","药房","急诊","住院","恢复","综合"], [["병원","医院","hospital"],["의사","医生","doctor"],["간호사","护士","nurse"],["환자","患者","patient"],["진료","诊疗","medical care"],["예약","预约","appointment"],["증상","症状","symptom"],["통증","疼痛","pain"],["열","发烧","fever"],["기침","咳嗽","cough"],["검사","检查","test"],["결과","结果","result"],["약","药","medicine"],["처방전","处方","prescription"],["응급실","急诊室","emergency room"],["입원","住院","hospitalization"],["퇴원","出院","discharge"],["건강","健康","health"],["쉬다","休息","rest"],["낫다","痊愈","recover"]]],
  ["work", "工作兼职", "직장과 아르바이트", "💼", ["办公室","职业","求职","面试","排班","薪资","同事","会议","任务","综合"], [["회사","公司","company"],["직장","职场","workplace"],["직원","员工","employee"],["사장","老板","boss"],["동료","同事","colleague"],["업무","业务工作","work"],["회의","会议","meeting"],["보고서","报告","report"],["일정","日程","schedule"],["마감","截止日期","deadline"],["면접","面试","interview"],["이력서","简历","resume"],["지원서","申请书","application"],["아르바이트","兼职","part-time job"],["시급","时薪","hourly wage"],["월급","月薪","monthly salary"],["출근","上班","go to work"],["퇴근","下班","leave work"],["휴가","休假","vacation"],["근무하다","工作","work"]]],
...
const koreanPrefixes: Record<string, string[]> = {
  ...
  hospital: ["접수", "신체", "증상", "검사", "치료", "약국", "응급", "입원", "회복", "종합"],
  work: ["사무실", "직업", "취업", "면접", "근무표", "급여", "동료", "회의", "업무", "종합"],
  fitness: ["달리기", "구기", "헬스", "기구", "동작", "경기", "야외", "식단", "부상", "종합"],
  movies: ["영화", "텔레비전", "장르", "제작", "역할", "시청", "평가", "음악", "프로그램", "종합"],
  social: ["친구", "모임", "가족", "취미", "감정", "예절", "축제", "대화", "휴식", "종합"],
};
...
const makeChapter = ([id, titleChinese, titleKorean, emoji, prefixes, seeds]: ChapterSpec): Chapter => ({
  ...
  lessons: prefixes.map((prefix, lessonIndex) => ({
    id: `${id}-${lessonIndex + 1}`,
    titleChinese: `${prefix}${titleChinese}`,
    titleKorean: `${koreanPrefixes[id][lessonIndex]} ${titleKorean}`,
